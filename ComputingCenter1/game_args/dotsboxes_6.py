...
class Args(AbstractArgs):
    ...
    def __init__(self):
        ...
        self.train_num_search = 100  # simulation search times
        ...
        self.replay_buffer_threshold = 10  # replay_buffer 中只留最近5次迭代的数据
        ...
        self.CenterName = 'Computing Center'
        self.timeout_recycle = 1400
        self.p_v_dict_length = 0  # Occupies about 400MB of memory
        self.p_v_dict_layers = 0