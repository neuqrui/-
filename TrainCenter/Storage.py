...
class Storage:
    ...
    def load_total_train_data(self, replay_buffer):
        ...
        if not os.path.isfile(examples_file):
            print("File with train_data not found. Continue? [y|n]")
            # r = input()
            # if r != "y":
            #     sys.exit()
        else:
            print("Find the total train_data")
            with open(examples_file, "rb+") as f:
    ...
    def load_iter_train_data(self, replay_buffer):
        ...
        if not os.path.isfile(examples_file):
            ...
            print("Find the iter train_data")
            with open(examples_file, "rb+") as f:
    ...
    def save_time_train(self, iter_num, time_train):
        """
        ...
        with open(file_name, "a") as file_point:
            file_point.write("Iter " + str(iter_num) + " :" + "    Train:  " + str("%.2f" % time_train) + " s" + '\n')
...
class Log:
    ...
    def print_vs_info(args, num_player_1, num_player_2):
        ...
        player_1 = ""
        player_2 = ""
        if args.GAME_NAME[:-2] == 'amazons':
            player_1 = "White "
            player_2 = "Black "
        elif args.GAME_NAME[:-2] == 'go':
            player_1 = "White "
            player_2 = "Black "
    ...
    @staticmethod
    def print_simulation_results(strings, simulation_n, simulation_q):
        print(strings, simulation_n, simulation_q)
